...
define('vs/language/typescript/languageFeatures', [
  ...
  function s(e, t, r) {
    ...
    if (((n += e.messageText), r++, e.next))
      for (var o = 0, a = e.next; o < a.length; o++) {
        n += s(a[o], t, r)
      }
    return n
  }
  ...
  Object.defineProperty(t, '__esModule', { value: !0 }),
    ...
    (t.flattenDiagnosticMessageText = s)
  var a = (function() {
    function e(e) {
      this._worker = e
    }
  ...
  var c = (function(e) {
    function t(t, r, i, s) {
      ...
      var a = function(e) {
        ...
        l = function(e) {
          n.editor.setModelMarkers(e, o._selector, [])
          var t = e.uri.toString()
          o._listener[t] && (o._listener[t].dispose(), delete o._listener[t])
        }
      o._disposables.push(n.editor.onDidCreateModel(a)),
        o._disposables.push(n.editor.onWillDisposeModel(l)),
        o._disposables.push(
    ...
    return (
                ...
                return (
                  ...
                  e.isDisposed()
                    ...
                    : ((r = []),
                      ...
                      (s = i.noSyntaxValidation),
                      (o = i.noSemanticValidation),
      ...
      (t.prototype._convertDiagnostics = function(e, t) {
        var r = t.start || 0,
          ...
          p = []
        return (
          t.reportsUnnecessary && p.push(n.MarkerTag.Unnecessary),
          ...
          return (
            t.forEach(function(t) {
              ...
              if (t.file) {
                ...
                o = r._libFiles.getOrCreateModel(a)
              }
              if (o) {
                var l = t.start || 0,
                  u = t.length || 1,
  ...
  var d = (function(e) {
    ...
    return (
      ...
      (t.prototype.provideCompletionItems = function(e, r, i, s) {
        return __awaiter(this, void 0, void 0, function() {
          var i, s, o, a, l, u
              ...
              case 2:
                return !(u = c.sent()) || e.isDisposed()
                  ...
                  : [
                      2,
                      {
                        suggestions: u.entries.map(function(i) {
                          var l,
                            u = s
              ...
              case 1:
                return (
                  ...
                  e.isDisposed()
                    ...
                    : [
                        4,
                        a.getSignatureHelpItems(n.toString(), s, {
                ...
                return !(l = c.sent()) || e.isDisposed()
                  ...
                  : ((u = {
                    ...
                    l.items.forEach(function(e) {
                      ...
                      ;(t.documentation = { value: o(e.documentation) }),
                        (t.label += o(e.prefixDisplayParts)),
                        e.parameters.forEach(function(r, n, i) {
                          var s = o(r.displayParts),
                            a = {
                              label: s,
                              documentation: { value: o(r.documentation) }
                            }
                          ;(t.label += s),
                            t.parameters.push(a),
                            n < i.length - 1 &&
                              (t.label += o(e.separatorDisplayParts))
                        }),
            ...
            switch (l.label) {
              ...
              case 1:
                return (
                  ...
                  e.isDisposed()
                    ? [2]
                    : [4, s.getOccurrencesAtPosition(r.toString(), i)]
                )
              case 2:
            ...
            switch (g.label) {
              ...
              case 1:
                return (
                  ...
                  e.isDisposed()
                    ? [2]
                    : [4, s.getDefinitionAtPosition(r.toString(), i)]
                )
              case 2:
            ...
            switch (g.label) {
              ...
              case 1:
                return (
                  ...
                  e.isDisposed()
                    ? [2]
                    : [4, s.getReferencesAtPosition(r.toString(), i)]
                )
              case 2:
                return !(o = g.sent()) || e.isDisposed()
                  ? [2]
            ...
            switch (d.label) {
              case 0:
                return (
                  ...
                  (o = y._convertOptions(e.getOptions())),
                  (a = r.markers
                    .filter(function(e) {
                      return e.code
                    })
