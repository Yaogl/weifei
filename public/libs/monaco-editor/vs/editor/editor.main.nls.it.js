 ...
 *-----------------------------------------------------------*/ define('vs/editor/editor.main.nls.it', {
  ...
  'vs/base/browser/ui/iconLabel/iconLabel': ['Caricamento...'],
  ...
  'vs/editor/common/config/editorOptions': [
    ...
    "Controlla le dimensioni del carattere dei suggerimenti inline nell'editor. Quando \xE8 impostata su `0`, viene usato il 90% del valore di `#editor.fontSize#`.",
    ...
    "Controlla il numero di righe nell'editor che possono essere lette da un utilit\xE0 per la lettura dello schermo. Avviso: questa opzione pu\xF2 influire sulle prestazioni se il numero di righe \xE8 superiore a quello predefinito.",
    'Contenuto editor',
  ...
  'vs/editor/contrib/unusualLineTerminators/unusualLineTerminators': [
    ...
    'Questo file contiene uno o pi\xF9 caratteri di terminazione di riga insoliti, come separatore di riga (LS) o separatore di paragrafo (PS).\r\n\r\n\xC8 consigliabile rimuoverli dal file. \xC8 possibile configurare questa opzione tramite `editor.unusualLineTerminators`.',
